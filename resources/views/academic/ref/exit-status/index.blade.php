            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__head">
                    ...
                    <div style="text-align: right; padding-top: 0.5%;">
                        <a href="javascript:void(0)" value="{{ route('academic.ref.exit-status.create') }}" class="btn btn-success modalShow" title="Tambah Data" data-toggle="modal" data-target="#modalShow"><i class="fa fa-plus-circle"></i> Tambah Status Keluar</a>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <a href="javascript:void(0)" value="{{ route('academic.ref.exit-status.edit', ['id' => $item->id]) }}" class="btn btn-sm btn-icon btn-info modalShow" data-toggle="modal" title="Ubah Data" data-target="#modalShow"><i class="fa fa-edit"></i></a>
                                        <form style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')" action="{{ route('academic.ref.exit-status.delete', ['id' => $item->id]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
