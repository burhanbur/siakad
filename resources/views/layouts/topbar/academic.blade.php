<li class="kt-menu__item  @if(\Request::segment(2) == '' || \Request::segment(2) == 'home') kt-menu__item--active  @endif" aria-haspopup="true">
	<a href="{{ route('academic.home') }}" class="kt-menu__link ">
